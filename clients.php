...
$cleaner = new driver;
    ...
    if(isSet($_SESSION['login']) and $_SESSION['login'] ==1 ):
     ...
     $tags=array('title'=>'Microfin ltd','plugins'=>'sections/plugins.php','branch'=>'sections/branch.php','logo'=>'sections/logo.php','head'=>'sections/heading.php',
  ...
  unset($_SESSION);
 session_destroy();
 $tags=array('title'=>'Microfin ltd','plugins'=>'','branch'=>FCIPATH.DS.'sections'.DS.'branch.php','logo'=>FCIPATH.DS.'sections'.DS.'logo.php','head'=>'','navigation'=>'', 'arrange'=>'','search'=>'','main_content'=>'pages/login.php','footer'=>FCIPATH.DS.'sections'.DS.'footer.php');
    endif;
// parse template file
