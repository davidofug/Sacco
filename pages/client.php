...
<div id="loan_s_container"><form id="loan" method="post" action="process/loan.php">
<fieldset>
...
<div><label for="duration">Valid for a period of :</label><input style="width:60px" type="text" name="period" id="period" /> <select name="in"><option value="in">In</option>
<option value="M">Month(s)</option><option value="Y">Year(s)</option></select><br/><span>Leave blank to use pre-set 30(days)</span></div>
<div><label for="terms">Payment terms :</label>
<select name="terms">
<option value="1">Per Month</option>
<option value="2">Per Week</option>
<option value="3">Bi-Weekly</option>
<option value="4">Bi-Monthly</option>
<option value="6">Quartely</option>
<option value="7">Semi-annually</option>
<option value="8">Annually</option>
</select><span>Default is: Per Month</span>
</div>
<div><label for="interest">Interest rate :</label><input type="text" name="interestrate" id="interestrate" /><br/><span>Leave blank to use pre-set interest rate (20%)</span></div>
<div><label for="disbamount">Disb amount: <em><img src="templates/microfin/imgs/star.gif"/></em></label><input type="text" name="disbamount" id="disbamount" class="required"/></div>
</fieldset>
<fieldset class="submit"><input type="submit" value="submit" name="loansubmit" id="loansubmit" /></fieldset>
...
<div class="wide"  id="deposit"><h2>Deposit</h2>
