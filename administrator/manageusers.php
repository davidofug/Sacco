	...
	if(isset($login)){
		...
		if($login==1 && $lvl==2){
					echo '<p><a href="settings.php">Settings</a> | <a href="transactions.php">Transactions</a> | <a href="manageusers.php">Manage Users</a> | <a href="../process/getoff.php">LogOut</a></p>';
			...
			$account = trim(stripslashes(strip_tags($_GET['acc'])));
				if(!empty($action) and !empty($account)){
					...
					echo '<p class="error">Please choose action <a href="manageusers.php" title="Manage users" >List of Users</a></p>';
					}
